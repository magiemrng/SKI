  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-10 w-4 h-4 bg-ski-accent rounded-full shadow-lg z-40"
      />
      <motion.div
        animate={{ 
          y: [0, 15, 0],
        ...
        className="absolute bottom-1/4 right-10 w-6 h-6 border-2 border-ski-accent rounded-full shadow-lg z-40"
      />
      <motion.div
        animate={{ 
          scale: [1, 1.5, 1],
        ...
        className="absolute top-1/3 right-1/4 w-3 h-3 bg-ski-accent rounded-full shadow-lg z-40"
      />
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/4 w-2 h-2 bg-orange-400 rounded-full shadow-md z-40"
      />
      <motion.div
        animate={{ 
          x: [0, -15, 0],
        ...
        className="absolute bottom-1/3 left-1/3 w-5 h-5 border border-orange-400 rounded-full shadow-md z-40"
      />
    </section>
  );
};
